...
<body>
	...
	<!-- 
	 ...
	 -->	
		<tr>
			<th>영화 이름</th>
			<td><input type="text" name="mName" size="40" value="${modify.MName}"/></td>		
		</tr>
		<tr>
			<th>영화 장르</th>
			<td><select name="mCategory" id="Mcategory" value="${modify.MCategory}">
			...
			<tr>
			<th>감독</th>
			<td><input type="text" name="mDirector" size="40" value="${modify.MDirector}"/></td>		
		</tr>
		<tr>
			<th>배우</th>
			<td><input type="text" name="mActors" size="40" value="${modify.MActors}"/></td>	
		</tr>
		<tr>
			<th>줄거리</th>
			<td><textarea rows="20" cols="40" name="mStory" placeholder="100글자 이내" value="${modify.MStory}"></textarea></td>		
		</tr>
		
		<tr>
			<th>관람연령</th>
			<td><select name="mAge" id="Mage" value="${modify.MAge}">
		...
		<tr>
				<th>개봉일</th>
				<th><input type="date" name="mDate" size=33 value="${modify.MDate}"/> <br /></th>
			</tr>
			<tr>
			<th>상영시간</th>
			<td><input type="text" name="mRtime" size="40" value="${modify.MRtime}"/></td>		
		</tr>
			<tr>
			<th>메인포스터</th>
