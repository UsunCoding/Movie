...
<body>
	...
	<main id="main" data-aos="fade" data-aos-delay="1500">
	 ...
	 -->
				<tr>
					<th>영화 코드</th>
					<td><select name="mCode" value="${modify.MCode}">
				...
				<tr>
					<th>영화관 코드</th>
					<td>
					<select name="emgCode" value="${modify.emgCode}">
				...
				<tr>
					<th>영화 날짜</th>
					<td><input type="date" name = "emsDate" value="${modify.emsDate}"></td>
				</tr>
				<tr>
					<th>영화 시간</th>
					<td><input type="time" name = "emsTime" value="${modify.emsTime}">~<input type="time" name = "emsTime" value="${modify.emsTime}"></td>
				</tr>
