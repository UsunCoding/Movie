...
<form action="euJoin" method="POST" encType="multipart/form-data">
		<table class="listbox" id="listbox">
			...
			<tr>
				<th>아이디</th>
				<td><input type="text" name="euId" id="euId" size=33 class = "listbox"/> <br />
				<span id="check1"></span><br /></td>
			...
			<tr id="tr1">
				...
				<td><input type="password" name="euPw" id="euPw"
					placeholder="영문, 숫자, 특수문자를 혼합해서 8자 이상" size=33 class = "listbox" /> <br /> 
				<span id="check2"></span><br /></td>
			</tr>
			<tr id="tr1">
				<th>비밀번호 확인</th>
				<td><input type="password" id="checkPw" size=33 class = "listbox" /> <br /> 
				<span id="check3"></span><br /></td>
			</tr>
			<!-- 5 -->
			<tr>
				<th>이름</th>
				<td><input type="text" name="euName" size=33 class = "listbox" /> <br /> <br /></td>
			</tr>
			<!-- 6 -->
			<tr>
				<th>생년월일</th>
				<td><input type="date" name="euBirth" size=33 class = "listbox" /> <br /></td>
			</tr>

			<!-- 7 -->
			<tr id="tr1">
				<th>성별 </th>
				<td>남자 <input type="radio" name="euGender" value="남자" /> 여자 <input
					type="radio" name="euGender" value="여자"  /> <br /> <br />
				</td>
			</tr>
			<!-- 8 -->
			<tr id="tr1">
				<th>이메일</th>
				<td><input type="email" name="euEmail" size=33 class = "listbox" /> <br /> <br /></td>
			</tr>
			<!-- 9 -->
			<tr>
				<th>연락처</th>
				<td><input type="text" name="euPhone" size=33 class = "listbox" /> <br /> <br /></td>
			</tr>
			<tr>
				<th>주소</th>
				<td> 
				
					<input type="text" name="addr1" id="sample6_postcode" placeholder="우편번호" class = "listbox2">
			...
			<tr>
				<th>프로필 사진</th>
				<td><input type="file" name="euProfile" class = "listbox"/> <br /> <br /></td>
			</tr>
			<!-- 10 -->
			<tr>
				<th colspan="2"><input type="submit" value="가입"  class ="listbox1" /> <input
					type="reset" value="다시작성"  class ="listbox1" /> <br /></th>
			</tr>
