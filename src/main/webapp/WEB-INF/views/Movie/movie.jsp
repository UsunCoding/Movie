...
<body>
	...
	<main id="main" data-aos="fade" data-aos-delay="1500">
	 ...
	 -->
				...
				<tr>
					<th>메인포스터</th>
					<td><input type="file" name="mMainFile" class = "listbox" /></td>
				</tr>
				<tr>
					<th>스틸컷1</th>
					<td><input type="file" name="mStillcut1" class = "listbox" /></td>
				</tr>

				<tr>
					<th>스틸컷2</th>
					<td><input type="file" name="mStillcut2" class = "listbox" /></td>
				</tr>

				<tr>
					<th>스틸컷3</th>
					<td><input type="file" name="mStillcut3" class = "listbox" /></td>
				</tr>

				<tr>
					<th>스틸컷4</th>
					<td><input type="file" name="mStillcut4" class = "listbox" /></td>
				</tr>
