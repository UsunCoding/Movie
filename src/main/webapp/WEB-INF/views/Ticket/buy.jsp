...
<header id="header" class="header d-flex align-items-center fixed-top">
	...
	<input type="hidden" id="euId" value="${loginId}"/>
	<table>
		<tr>
			<th>극장</th>
			<th>영화</th>
		...
		<tr>
			...
			<!-- 상영관 선택 -->		
				<select id="select_emgCode" class = "listbox" >
			...
			<!-- 영화목록 불러오기 -->	
				<select id="select_mCode" class = "listbox" >
			...
			<td style='vertical-align:top'>
				<div id="timeTableBox" style="border-right: 1px solid black; overflow: hidden; width: 200px; height: 432px; float: left;">
				</div>
			</td>
			<td style='vertical-align:top' width=150px;>
			<button id="reserve" >예매확인</button>
	...
	<tr>
		<td id="reserveTableBox" style="border-right: 1px solid black; overflow: hidden; width: 200px; height: 432px; float: left;">
		</td>
	</tr>
	</table>	
...
function rsvCheck(rsvList) {
	let output = "";	
		...
		output += "<td>"+rsvList.reserveId+"</td>";
		output += "<td>"+rsvList.emgCode+"</td>";
		output += "<td>"+rsvList.mCode+"</td>";
		output += "<td>"+rsvList.emsDate+"</td>";
		output += "<td>"+rsvList.emsTime+"</td>";
